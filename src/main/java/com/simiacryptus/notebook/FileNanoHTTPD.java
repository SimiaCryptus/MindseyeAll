...
public class FileNanoHTTPD extends NanoHTTPD implements FileHTTPD {
  ...
  public Response serve(@Nonnull final IHTTPSession session) {
    ...
    if (session.getMethod() == Method.GET) {
      ...
      Optional<Map.Entry<CharSequence, Function<IHTTPSession, Response>>> temp_02_0005 = getHandlers
      ...
      Optional<Function<IHTTPSession, Response>> handler = temp_02_0005.map(e -> {
        Function<IHTTPSession, Response> temp_02_0002 = e.getValue();
        RefUtil.freeRef(e);
        return temp_02_0002;
      });
      ...
      Optional<Map.Entry<CharSequence, Function<IHTTPSession, Response>>> temp_02_0006 = this.postHandlers
          .entrySet().stream().filter(e -> {
      ...
      Optional<Function<IHTTPSession, Response>> handler = temp_02_0006.map(e -> {
        Function<IHTTPSession, Response> temp_02_0004 = e.getValue();
        RefUtil.freeRef(e);
        return temp_02_0004;
      });
