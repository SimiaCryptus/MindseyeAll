...
public class MaxPoolingLayer extends LayerBase {
  ...
  private static final Function<CalcRegionsParameter, RefList<Tuple2<Integer, int[]>>> calcRegionsCache = Util
  ...
  private static RefList<Tuple2<Integer, int[]>> calcRegions(final CalcRegionsParameter p) {
